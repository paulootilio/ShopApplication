...
class StockItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stock_item" do
    assert_difference('StockItem.count') do
      post stock_items_url, params: { stock_item: { product_id: @stock_item.product_id, stock: @stock_item.stock, store_id: @stock_item.store_id } }
    end
  ...
  test "should update stock_item" do
    patch stock_item_url(@stock_item), params: { stock_item: { product_id: @stock_item.product_id, stock: @stock_item.stock, store_id: @stock_item.store_id } }
